...
struct node *insert_beg(struct node *start)
{
    ...
    new_node -> data = num;
    new_node -> next = start; //Add the new node as the first node of the list by making the NEXT part of the new
                              // node contain the address of START.
    start = new_node;
    return start;
}
...
struct node *insert_end(struct node *start)
{
    ...
    new_node = (struct node *)malloc(sizeof(struct node));
    new_node -> data = num;
    new_node -> next = NULL;//Add the new node as the first node of the list by making the NEXT part of the new
                              // node contain the address of NULL.(NEXT field of the new node contains NULL,)
    ptr = start;
    while(ptr -> next != NULL)
    ptr = ptr -> next;
    ptr -> next = new_node;
